export const projectsData = [
  {
    ...
    technologies:
      "Angular, Ionic, Node.js, TypeScript, Firebase Firestore, Document AI, Google Cloud Secret Manager.",
  ...
  },
  {
    ...
    liveLink: "https://launchflow-saas.vercel.app/", // <-- Live URL added here
    about:
    ...
    technologies:
      "Next.js, React, Supabase (PostgreSQL), TypeScript, Groq API, TailwindCSS, React Hook Form, ESLint.",
  ...
  },
  {
    ...
    technologies:
      "Next.js, React, Node.js, TypeScript, PostgreSQL, Prisma, Redux Toolkit, Playwright, Jest.",
